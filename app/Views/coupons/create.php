...
<div class="flex flex-col justify-between items-center mb-4">
  <h1 class="text-2xl mb-4">Criar Cupom</h1>
  ...
  <form action="/coupons/create" method="POST">
    <label>
      Nome:<br>
      <input class="border border-white rounded px-2 outline-hidden" type="text" name="code" placeholder="CUPOM10, CUPOM20..." required>
    </label>
    <br><br>
    <label>
      Desconto (%):<br>
      <input class="border border-white rounded px-2 outline-hidden" type="number" name="discount" step="1" min="1" required>
    </label>
    <br><br>
    <label>
      Valor mínimo (R$):<br>
      <input class="border border-white rounded px-2 outline-hidden" type="text" name="minimum_amount" required>
    </label>
    <br><br>
    <label>
      Data de expiração:<br>
      <input class="border border-white rounded px-2 outline-hidden" type="date" name="expires_at" required>
    </label>
    <br><br>
